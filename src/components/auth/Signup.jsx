...
const Signup = ({ onSignupSuccess, switchToLogin }) => {
  ...
  const handleSocialLogin = (provider) => {
    alert(`${provider} signup coming soon! For now, please use email/password.`);
        ...
        <div className="social-login-section">
          ...
          >
            ...
            <div className="button-text">
              <span className="main-text">More Signup Options</span>
      ...
      {showSocialModal && (
        <div className="modal-overlay" onClick={() => setShowSocialModal(false)}>
          <div className="social-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="modal-subtitle">Quick signup with your social account</p>
            ...
            <p className="modal-note">
              <small>🚧 Social signup coming soon! For now, please use email/password.</small>
            </p>
          </div>
        </div>
      )}
